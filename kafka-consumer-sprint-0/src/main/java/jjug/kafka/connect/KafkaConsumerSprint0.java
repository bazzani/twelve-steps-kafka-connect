...
public class KafkaConsumerSprint0 {
    ...
    public static void main(String[] args) {
        ...
        try (KafkaConsumer<String, GenericData.Record> consumer = new KafkaConsumer<>(config)) {
            ...
            while (true) {
                ...
                for (ConsumerRecord<String, GenericData.Record> kafkaRecord : records) {
    ...
    private static Properties getConfig() {
        ...
        config.put("group.id", "jjug-kafka-connect-sprint-0-0");
